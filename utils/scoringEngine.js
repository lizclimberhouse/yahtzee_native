// //1's - 6's 
// export const singles = (dice) => {
//   return dice.filter( d => d === value).reduce( (total, value) => {
//     return total + val
//   }, 0)
// }

// //3 of a kind, 4 of a kind, chance
...
// //static scores
// export const staticScores = (type, dice) => {
//   switch (type) {
//     case 'Full House':
...
// // HELPERS FOR OUR HELPER FUNCTIONS
